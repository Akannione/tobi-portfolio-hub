const projects = {
  ...
  businessos: {
    ...
    image: 'assets/images/business_os_mvp.png',
    alt: 'Live CBOS patient reactivation call list with timing, ownership, and outcomes',
    frameLabel: 'Live CBOS Reactivation Workflow',
    results: [
      'Production Atlas-backed workflow deployed',
      'Owner, outcome, and timing filters in one call list',
      'Desktop and mobile WebKit production checks passed',
    ],
    links: [
